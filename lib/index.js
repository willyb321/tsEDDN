...
app.get('/api/cmdr/:cmdr', (req, res) => {
    ...
    utils_1.default.connectDB()
        ...
        collection
            ...
            const count = yield collection.count({ uploader: cmdr });
...
app.get('/api/system/:system', (req, res) => {
    ...
    utils_1.default.connectDB()
        ...
        collection
            ...
            const count = yield collection.count({ StarSystem: system });
            let newdocs = {
                currentPage: page,
                perPage: 25,
                total: count,
...
app.get('/api/station/:station', (req, res) => {
    ...
    utils_1.default.connectDB()
        ...
        collection
            ...
            const count = yield collection.count({ StarSystem: station });
            let newdocs = {
                currentPage: page,
                perPage: 25,
                total: count,
